...
<head>
	...
	<title>Services - Rainy Responsive Multipurpose Template</title>
    ...
    <header id="header" class="container">
        ...
        <div class="row">
            ...
            <div id="logo-bar" class="col-sm-12 ">
                <div id="logo">
                    <h1><a href="index.php"><img src="images/logo.png" alt="Rainy" /></a></h1>
                </div>
            </div>
        </div>
        <div class="row">
			...
			<div class="container">
                ...
                <div class="row sub_content">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="serviceBox_3 red_box">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="serviceBox_3 yellow_box">
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="serviceBox_3 green_box">
                            <i class="fa fa-briefcase"></i>
                    ...
                    <div class="col-sm-6 col-md-3 col-lg-3">
                        <div class="serviceBox_3 blue_box">
                            <i class="fa fa-briefcase"></i>
                            <h3>Free Support & Updates</h3>
                            <p>Cras mattis consectetur purus sit amet fermen. Lorem ipsum dolor sit amet, consec adipiscing elit. Maecenas sed diam eget risus varius bland sit amet non fringilla ullamcorper magna.</p>
                        </div>
                ...
                <div class="row sub_content">
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						<div class="serviceBox_4">
							<div class="service_4_img">
								<img alt="" src="images/services/1.png">
							</div>
							<h3>Clean &amp; Minimal</h3>
							<p>Cras mattis consectetur purus sit amet fermen. Lorem ipsum dolor sit amet, consec adipiscing elit. Maecenas sed diam eget risus varius bland sit amet non fringilla ullamcorper magna.</p>
						</div>
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						<div class="serviceBox_4">
							<div class="service_4_img">
								<img alt="" src="images/services/2.png">
							</div>
							<h3>Awesome Design</h3>
							<p>Cras mattis consectetur purus sit amet fermen. Lorem ipsum dolor sit amet, consec adipiscing elit. Maecenas sed diam eget risus varius bland sit amet non fringilla ullamcorper magna.</p>
						</div>
					...
					<div class="col-sm-4 col-md-4 col-lg-4">
						<div class="serviceBox_4">
							<div class="service_4_img">
								<img alt="" src="images/services/3.png">
							</div>
							<h3>Free Support & Updates</h3>
							<p>Cras mattis consectetur purus sit amet fermen. Lorem ipsum dolor sit amet, consec adipiscing elit. Maecenas sed diam eget risus varius bland sit amet non fringilla ullamcorper magna.</p>
						</div>
