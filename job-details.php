                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <nav id="breadcrumbs">
                        <ul>
                            ...
                            <li><a href="index.php">shortcodes</a></li>
                            <li>job-details</li>
                        </ul>
                    </nav>
                </div>
				...
				<div class="row sub_content">
					<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
						<div class="dividerHeading">
							<h4><span>Job Details</span></h4>

						</div>
					</div>
					<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
					<p>
						Recently<b> Guwahati University</b> have invite job application for the post <b> Junior Asistant,Section Asistant and Cashier.</b> the job's eligibility like educational qualifications,age limit,experiences,name of the posts,number of posts,selection process,application fee,how to apply,important links,etc are given below: 
                     </p>	 
					 </div>
					<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
						<h4>Name of the Post(s):</h4>
						<p>not Mentioned.</p>
					</div>
					...
					<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
						 <h4>Required Experiece(s)</h4>
					 <p>Not Required.</p>
					</div>
					<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
					<h4> Selection Process:</h4>
					 <p>The selection process and exam pattern for <b>Junior Asistant,Section Asistant and Cashier of Guwahati University is as follows:</b></p>
					 <p>Not Mentioned.</P>
					 </div>
					 <div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
					 ...
					 <div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
					 <h4>How To Apply</h4>
					 <p>Candidates can apply for the job <b> Junior Asistant,Section Asistant and Cashier of Guwahati University </b> by clicking on <b> Apply For The Job</b>button</p>
				      </div>
				<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
					<h4>Important Link(s):</h4>
					 <p>Short Advertisement Link(s):<b><i>Click Here<i><b></p>
					 <p>Details Advertisement Link:<b><i>Click Here<i><b></p>
					 </div>
					 <div class="col-lg-12 col-md-12 col-sm-10 col-xs-12">
					 <h4>About</h4>
					 <p><a href="index.php">AssamJobSee.com</a>  as a informar regarding various job vacacies like Government,Private and Public sector undertaking Educational Institutions.</p>
					 </div>
				</div>
