  ...
  <body class="home">
      ...
      <div id="top-fix" class="clearfix">
          ...
          <section class="slider">
              ...
              <div class="slide">
                  <div class="s1a" data-position="80,230" data-in="left" data-out="Right" data-delay="50"
                      style="min-width: 19%;">Welcome to AssamJobSee.com</div>

                  <div class="s1b" data-position="140,230" data-in="right" data-out="left" data-delay="100"
                      style="min-width: 34%;">We are always Ready to Help people</div>

                  <img src="images/fraction-slider/postpic.png" width="340" height="340" data-position="2,1150"
                      data-in="fade" data-out="fade" data-delay="500" style="width:auto; height:auto">
              </div>
              <div class="slide">

                  <div class="s1a" data-position="80,230" data-in="top" data-out="top" data-delay="200"
                      style="min-width: 22%;">Amazing various job here</div>

                  <div class="s1b" data-position="140,230" data-in="bottom" data-out="bottom" data-delay="400"
                      style="min-width: 33%;">We are Provide Awesome Information</div>

                  <img src="images/fraction-slider/gadgets/laptop.png" width="456" height="272" data-position="70,1180"
                      data-in="bottom" data-out="bottom" data-delay="1100">

                  <img src="images/fraction-slider/gadgets/mack.png" width="357" height="313" data-position="20,1040"
                      data-in="top" data-out="bottom" data-delay="900">

                  <img src="images/fraction-slider/gadgets/ipad.png" width="120" height="170" data-position="150,1030"
                      data-in="left" data-delay="1000" data-out="left">

                  <img src="images/fraction-slider/gadgets/smartphone.png" width="70" height="140"
                      data-position="195,1320" data-in="right" data-delay="1000" data-out="right">
              </div>
              <div class="slide">
                  <div class="s1a" data-position="70,230" data-in="top" data-out="top" style="min-width: 16%;">
                      AssamJobSee.com</div>

                  <div class="s1b" data-position="130,230" data-in="bottom" data-out="bottom" style="min-width: 25%;">
                      Everytime We are to Help</div>

                  <div class="list" data-position="70,900" data-in="left" data-out="left" data-delay="1000">Welcome to
                      AssamJobSee.com</div>

                  <div class="list" data-position="130,900" data-in="left" data-out="left" data-delay="1500">Find your
                      dream job</div>

                  <div class="list" data-position="190,900" data-in="left" data-out="left" data-delay="2500">Private &
                      Government job</div>

                  <div class="list" data-position="250,900" data-in="left" data-out="left" data-delay="3500">Always
                      Welcome</div>

                  <div class="list" data-position="70,1250" data-in="right" data-out="right" data-delay="1000"> Search
                      better career</div>

                  <div class="list" data-position="130,1250" data-in="right" data-out="right" data-delay="1500"> Amazing
                      various job here</div>

                  <div class="list" data-position="190,1250" data-in="right" data-out="right" data-delay="2500">Latest
                      job below</div>

                  <div class="list" data-position="250,1250" data-in="right" data-out="right" data-delay="3500">You are
                      most welcome</div>
              ...
              <div class="container">
                  <div class="row">
                      <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                          ...
                          <div class="blog_medium" id="load_data">
                              <div class="row" id="tytle"></div>
                              ...
                              <?php
								...
								if(isset($_GET['id'])){
									...
									$sql="select * from post where post_category=$cat_id order by post_id desc limit {$offset}, {$limit}";
                              ...
                              <article class="post">
                                  ...
                                  <div class="post_content">
                                      <div class="post_meta">
                                          <h4>
                                              <a
                                                  href="blog-post.php?id=<?php echo $row['post_id']?>"><?php echo $row['title']?></a>
                                          </h4>
                                          <div class="metaInfo">
                                              <span><i class="fa fa-calendar"></i> <a
                                                      href="blog-post.php?id=<?php echo $row['post_id']?>"><?php echo $row['date']?></a>
                                              </span>
                                              <span><i class="fa fa-map-marker"></i> <a
                                                      href="#">Location:<?php echo $row['location']?></a></span>
                                              <span><i class="fa fa-inr"></i> <a
                                                      href="blog-post.php?id=<?php echo $row['post_id']?>">Salary:<?php echo $row['salary']?></a></span>
                                          </div>
                                      </div>
                                      <p> <?php echo substr($row['job_details'],0,130) . "...";?></p>
                                      <a class="btn btn-small btn-default"
                                          href="blog-post.php?id=<?php echo $row['post_id']?>">Read More</a>
                                  </div>
                              </article>
                              <?php
										}
									...
									if(isset($_GET['id'])){
								   $cat=$_GET['id'];
							$sql2="select cat_post from cat_job where id='$cat'";
							$result2=mysqli_query($con,$sql2);
							 ...
							 if(mysqli_num_rows($result2)>0){
							  ...
							  if($page>1){
								  echo'<li class="page-item"><a class="page-link" href="category.php?id='.$cat.'& page='.($page - 1).'">previous</a></li>';
							  }
							  ...
							  echo'<li class="page-item '.$active.'"><a class="page-link" href="category.php?id='.$cat.'& page='.$i.'">'.$i.'</a></li>';
							  }
							  if($total_page > $page){
								  echo'<li class="page-item"><a class="page-link" href="category.php?id='.$cat.'& page='.($page + 1).'">next</a></li>';
							  }
							  echo'</ul>';
						        }		
                               }else{
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12">
                              <div class="more-job-btn mt-5 text-center" id="load_data_message"></div>
                      ...
                      <div class="col-xs-12 col-md-4 col-lg-4 col-sm-4">
                          <div class="sidebar">
                              <div class="widget widget_search">
                                  <div class="site-search-area">
                                      <form action="#" id="site-searchform" method="get">
                                          <div>
                                              <input type="text" placeholder="Job Search keywords..." id="s" name="s"
                                                  class="input-text">
                              ...
                              <div class="widget widget_categories">
                                  ...
                                  <?php 
						   include "config.php";
						   $sql="select * from cat_job where cat_post>0";
						   ...
						   ?>
                              ...
                              <div class="widget widget_tab">
                                  <ul class="nav nav-tabs">
                                      ...
                                      <li class="last-tab"><a data-toggle="tab" href="#Recent-Comment"><i
						  ...
						  while($row=mysqli_fetch_assoc($result)){
							  ?>
                                          <ul class="recent_tab_list">
                                              <li>
                                                  <span><a href="blog-post.php?id=<?php echo $row['post_id']?>"><img
                                                              alt="" src="images/content/recentpost.png"></a></span>
                                                  <a
                                                      href="blog-post.php?id=<?php echo $row['post_id']?>"><?php echo $row['title']?></a>
					  ...
					  if(mysqli_num_rows($result)>0){
						  while($row=mysqli_fetch_assoc($result)){
                              ...
                              <div class="widget widget_tags">
                                  <div class="widget_title">
                                      <h4><span>Alert</span></h4>
                                  </div>
                                  <div class="widget widget_search">
                                      <div class="site-search-area">
                                          <form action="email-proccess.php" method="post">
                                              <input class="form-control" type="email" name="email"
                                                  placeholder="Your email here" onfocus="this.placeholder = ''"
                                                  onblur="this.placeholder = 'Your email here'" required>
                                              <button type="submit" name="submit" class="btn btn-default">subscribe
                                                  now</button>
                                          </form>
                                      </div>
                                  </div>
    ...
    <section class="promo_box">
              ...
              <div class="row">
                  <div class="col-sm-6 col-md-3 col-lg-3">
                      ...
                      <div class="widget_content">
                          <p>We are as a informar regarding various job vacacies like Government,Private and Public
                              sector undertaking Educational Institutions.</p>
                          <ul class="contact-details-alt">
                              <li><i class="fa fa-map-marker"></i>
                                  <p><strong>Address</strong>:Guwahati,sixmile ,Assam,India</p>
                              </li>
                              <li><i class="fa fa-user"></i>
                                  <p><strong>Phone</strong>:(+91) 8472083737</p>
                              </li>
                              <li><i class="fa fa-envelope"></i>
                                  <p><strong>Email</strong>: <a
                                          href="mailto:mushtaqueahmed178@gmail.com">mushtaqueahmed178@gmail.com</a></p>
                              </li>
                          </ul>
                      </div>
                  </div>
                  <div class="col-sm-6 col-md-3 col-lg-3">
					  ...
					  if(mysqli_num_rows($result)>0){
                          ...
                          <ul class="links">
                              <li><a
                                      href="blog-post.php?id=<?php echo $row['post_id']?>"><?php echo $row['title']?><span><?php echo $row['date']?></span></a>
                              </li>
                          </ul><?php
						  }
					      }
      ...
      <section class="footer_bottom">
          <div class="container">
              <div class="row">
                  <div class="col-md-6">
                      <p class="copyright">&copy; Copyright <script>
                          document.write(new Date().getFullYear());
                          </script> All rights reserved | Powered by <a href="https://www.yahoobaba.net/">Yahoo Baba</a>
                      </p>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="footer_social">
                          <ul class="footbot_social">
                              <li><a class="fb" href="#." data-placement="top" data-toggle="tooltip" title="Facbook"><i
						 ...
						 $.ajax({
							 ...
							 success:function(data){
								 $('#load_data').append(data);
								   if(data==''){
									   $('#load_data_message').html("<button type='button' class='btn btn-info'>No record Found</button>");
									   action='active';
								   }else{
