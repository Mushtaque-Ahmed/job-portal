            ...
            <div class="container">
                ...
                <div class="row sub_content">
                    <div class="col-lg-12 col-md-12 col-sm-12">
					  ...
					  <h4 class="text-center" style="color:blue"><i>You are Most Welcome<i>,<?php echo $_SESSION['user'];?></h4>
                       <h4 class="text-center" style="color:blue"><a href="post.php">Add Post</a></h4>
								 ...
								 $limit=3;
					               if(isset($_GET['page'])){
						             $page=$_GET['page'];
									   ...
									   $offset=($page - 1) * $limit;
                               $q="select * from post order by post_id desc limit {$offset},{$limit}";
						...
						if(mysqli_num_rows($result)>0){
							...
							for($i=1; $i<=$total_page; $i++){
								if($i==$page){
								  ...
								  echo'<li class="page-item '.$active.'"><a class="page-link" href="adminpanel.php?page='.$i.'">'.$i.'</a></li>';
							}
							 if($total_page > $page){
					...
					<div class="text-center"><a href="logout.php"><b>Log-out<b></a></div>
                </div> <!--./row-->
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="our_clients">
                        <ul class="client_items clearfix">
                            <li class="col-sm-3 col-md-3 col-lg-3"><a href="services.php"  data-placement="top" data-toggle="tooltip" title="client 1" ><img src="images/clients/1.png" alt="" /></a></li>
                            <li class="col-sm-3 col-md-3 col-lg-3"><a href="services.php" data-placement="top" data-toggle="tooltip" title="client 2" ><img src="images/clients/2.png" alt="" /></a></li>
                            <li class="col-sm-3 col-md-3 col-lg-3"><a href="services.php" data-placement="top" data-toggle="tooltip" title="client 3" ><img src="images/clients/3.png" alt="" /></a></li>
                            <li class="col-sm-3 col-md-3 col-lg-3"><a href="services.php" data-placement="top" data-toggle="tooltip" title="client 4" ><img src="images/clients/4.png" alt="" /></a></li>
                        </ul><!--/ .client_items-->
                    </div>
                </div>
            </div> <!--./row-->
